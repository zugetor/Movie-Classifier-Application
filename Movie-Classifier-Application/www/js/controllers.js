angular.module("starter.controllers", [])
	...
	.controller("FavoriteCtrl", function($scope, $rootScope, $ionicModal, FavAdd) {
		$scope.favlist = [{
	...
	.controller("ShowmovieCtrl", function(
		...
		$scope.addfav = function() {
			FavAdd.update($scope.moviedetail["imdbID"],$scope.moviedetail["Title"],$scope.moviedetail["Poster"],$scope.moviedetail["Year"]);
		};
	})
	...
	.controller("BoxofficeCtrl", function($scope, $ionicModal) {
		...
		var box = {
			Daily: [{
					...
					imdbID: "tt5848272",
					Gross: "$4,842,000",
					Poster: "https://m.media-amazon.com/images/M/MV5BMTYyNzEyNDAzOV5BMl5BanBnXkFtZTgwNTk3NDczNjM@._V1_UX182_CR0,0,182,268_AL_.jpg"
				},
				{
					Title: "The Grinch (2018)",
					imdbID: "tt2709692",
					Gross: "$4,745,000",
					Poster: "https://m.media-amazon.com/images/M/MV5BYmE5Yjg0MzktYzgzMi00YTFiLWJjYTItY2M5MmI1ODI4MDY3XkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_UX182_CR0,0,182,268_AL_.jpg"
				},
				{
					Title: "Creed II",
					imdbID: "tt6343314",
					Gross: "$2,807,044",
					Poster: "https://m.media-amazon.com/images/M/MV5BMTcxMjUwNjQ5N15BMl5BanBnXkFtZTgwNjk4MzI4NjM@._V1_UX182_CR0,0,182,268_AL_.jpg"
				},
				{
					Title: "Fantastic Beasts: The Crimes of Grindelwald",
					imdbID: "tt4123430",
					Gross: "$1,885,000",
					Poster: "https://m.media-amazon.com/images/M/MV5BZjFiMGUzMTAtNDAwMC00ZjRhLTk0OTUtMmJiMzM5ZmVjODQxXkEyXkFqcGdeQXVyMDM2NDM2MQ@@._V1_UX182_CR0,0,182,268_AL_.jpg"
				}
			],
			Weekly: [{
					Title: "Ralph Breaks the Internet",
